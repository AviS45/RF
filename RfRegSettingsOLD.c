...
// Channel spacing = 199.951s172 kHz
// Channel number = 0
// Optimization = -
// Sync mode = (3) 30/32 sync word bits detected
// Format of RX/TX data = (0) Normal mode, use FIFOs for RX and TX
...
0x5b, // MDMCFG4 Modem configuration.//values changed
0xf8, // MDMCFG3 Modem configuration.//values changed
0x03, // MDMCFG2 Modem configuration.//values changed

/*data rate is different but same frequency
0xCA, // MDMCFG4 Modem configuration.
0x83, // MDMCFG3 Modem configuration.
0x93, // MDMCFG2 Modem configuration.
*/
